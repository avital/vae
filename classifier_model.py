...
#      filters = [16, 16, 32, 64]
    ...
    with tf.variable_scope('unit_1_0'):
      x = res_func(x, x.get_shape()[3].value, filters[1], self._stride_arr(strides[0]),
    ...
    if self.use_vae_prog:
      x = tf.concat([x, self.vae.encoder1], axis=3)

    with tf.variable_scope('unit_2_0'):
      x = res_func(x, x.get_shape()[3].value, filters[2], self._stride_arr(strides[1]),
    ...
    if self.use_vae_prog:
      x = tf.concat([x, self.vae.encoder2], axis=3)

    with tf.variable_scope('unit_3_0'):
      x = res_func(x, x.get_shape()[3].value, filters[3], self._stride_arr(strides[2]),
    ...
    if self.use_vae_prog:
      x = tf.concat([x, self.vae.encoder3], axis=3)
